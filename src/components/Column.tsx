 ...
 * 
 * Este componente permite mostrar, editar y eliminar una columna, así como ordenar y añadir tarjetas dentro de la columna.
 * 
 * @param {ColumnProps} props - Las propiedades del componente.
 * @param {string} props.id - El ID de la columna.
 * @param {string} props.name - El nombre de la columna.
 * @returns {JSX.Element} - El componente de la columna.
 */
export default function Column({ id, name }: ColumnProps): JSX.Element {
  ...
  /**
   * Maneja el envío del formulario para renombrar la columna.
   * 

...
/**
 * Componente del cuerpo del modal de la tarjeta.
 * 
 * Este componente muestra los detalles de una tarjeta, permite editar el nombre de la tarjeta,
 * eliminar la tarjeta y ver y agregar comentarios.
 * 
 * @returns {JSX.Element} - El cuerpo del modal de la tarjeta.
 */
export default function CardModalBody(): JSX.Element {
